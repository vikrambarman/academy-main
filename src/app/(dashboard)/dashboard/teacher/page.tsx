                ...
                <div className="td-greeting">
                    ...
                    <div className="td-greeting-right">
                        <div className="td-today-pill">
                            <CalendarCheck size={14} style={{ color:"var(--tp-accent2)" }} />
                            <span>Today</span>
                        </div>
                        ...
                        return (
                            <div key={c.label} className="td-card"
                                ...
                                {loading ? (
                                    ...
                                    <>
                                        <div className="td-card-icon-wrap"
                        ...
                        return (
                            <a key={q.href} href={q.href} className="td-quick-card"
                                ...
                                <div className="td-quick-icon"
                                    style={{ color:q.color, background:`color-mix(in srgb, ${q.color} 10%, transparent)`, borderColor:`color-mix(in srgb, ${q.color} 25%, transparent)` }}>
                                    <Icon size={19} />
                                </div>
...
.td-skel {
    background: linear-gradient(90deg, var(--tp-surface) 25%, var(--tp-surface2) 50%, var(--tp-surface) 75%);
...
.td-greeting {
    ...
    border: 1px solid var(--tp-border); border-radius: 18px; padding: 26px 28px;
    position: relative; overflow: hidden;
}
.td-greeting::after {
    content: ''; position: absolute; top: -60px; right: -60px;
    width: 200px; height: 200px; border-radius: 50%;
    background: radial-gradient(circle, var(--tp-accent-glow) 0%, transparent 70%);
    pointer-events: none;
}
...
.td-greeting-eyebrow {
    ...
    letter-spacing: .12em; color: var(--tp-accent2);
}
.td-eyebrow-dot {
    width: 6px; height: 6px; border-radius: 50%;
    background: var(--tp-accent2);
    box-shadow: 0 0 8px var(--tp-accent2);
...
.td-today-pill {
    ...
    background: var(--tp-accent-glow); border: 1px solid var(--tp-accent-b);
    border-radius: 100px; font-size: 12px; font-weight: 700; color: var(--tp-accent2);
}
.td-refresh-btn {
...
.td-retry-btn {
    background: transparent; border: none; color: var(--tp-accent2);
...
.td-snapshot-bar {
    ...
    background: var(--tp-border); overflow: hidden; display: flex;
}
...
.td-section-count {
    ...
    background: var(--tp-surface2); color: var(--tp-muted);
}
...
.td-course-badge {
    ...
    background: var(--tp-accent-glow); border: 1px solid var(--tp-accent-b); color: var(--tp-accent2);
}
.td-course-cta {
    display: flex; align-items: center; gap: 5px;
    font-size: 11px; font-weight: 700; color: var(--tp-accent2);
    text-decoration: none; white-space: nowrap; opacity: .7; transition: opacity .13s;
}
...
.td-empty {
    padding: 32px; text-align: center; font-size: 13px; color: var(--tp-muted);
    background: var(--tp-surface); border: 1px dashed var(--tp-border); border-radius: 12px;
}
