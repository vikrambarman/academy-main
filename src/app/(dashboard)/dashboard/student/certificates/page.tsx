...
function getAuthorityInfo(authority?: string): AuthorityInfo {
    ...
    if (a.includes("drishti") || a.includes("dce")) return {
        ...
        bg:          "#eff6ff",
        border:      "#bfdbfe",
        portalLabel: "Drishti Portal",
        portalUrl:   "https://drishticce.com",
        helpText:    "Certificate issued under Drishti Computer Education authority. Verify online via Drishti portal.",
        steps: [
            "Visit the Drishti verification portal",
            "Enter your certificate number or student ID",
            "Download or print your verified certificate",
        ],
    };
    ...
    if (a.includes("gsdm") || a.includes("gramin") || a.includes("gsm")) return {
        ...
        steps: [
            "Visit graminskill.in portal",
            "Login with your registered credentials",
            "Navigate to Certificate section and download",
        ],
    };
    ...
    if (a.includes("nsdc") || a.includes("skill india") || a.includes("pmkvy")) return {
        ...
        bg:          "#fffbeb",
        border:      "#fde68a",
        portalLabel: "Skill India Portal",
        portalUrl:   "https://nsdcindia.org",
        helpText:    "Certificate issued under NSDC / Skill India framework. Verify via the official Skill India portal.",
        steps: [
            "Visit nsdcindia.org or skillindiadigital.gov.in",
    ...
    return {
        ...
        bg:          "#f8fafc",
        border:      "#e2e8f0",
        portalLabel: "Verify Certificate",
        portalUrl:   "",
        helpText:    "Certificate issued by the academy. Contact administration for verification details.",
        steps: [
            "Contact Shivshakti Computer Academy",
            "Provide your student ID and course name",
            "Academy will verify and confirm your certificate",
        ],
    };
}
...
function CertStatusBadge({ status }: { status: string }) {
    ...
    if (s === "issued") return (
        <span style={{ display:"inline-flex", alignItems:"center", gap:5, background:"#f0fdf4", color:"#15803d", border:"1px solid #bbf7d0", fontSize:11, fontWeight:700, padding:"5px 12px", borderRadius:100 }}>
            <CheckCircle2 size={12}/> Issued
        </span>
    );
    if (s === "processing") return (
        <span style={{ display:"inline-flex", alignItems:"center", gap:5, background:"#eff6ff", color:"#1d4ed8", border:"1px solid #bfdbfe", fontSize:11, fontWeight:700, padding:"5px 12px", borderRadius:100 }}>
            <Clock size={12}/> Processing
        </span>
    );
    return (
        <span style={{ display:"inline-flex", alignItems:"center", gap:5, background:"#fefce8", color:"#92400e", border:"1px solid #fde68a", fontSize:11, fontWeight:700, padding:"5px 12px", borderRadius:100 }}>
...
export default function StudentCertificates() {
    ...
    if (loading) return (
        <div style={{ padding:"48px 0", display:"flex", flexDirection:"column", alignItems:"center", gap:14 }}>
            ...
            <span style={{ fontSize:13, color:"#64748b", fontFamily:"'Plus Jakarta Sans',sans-serif" }}>Loading certificates…</span>
        </div>
    );
    ...
    return (
        <>
            <style>{`
                ...
                .sc-root { font-family:'Plus Jakarta Sans',sans-serif; color:#0f172a; }
                ...
                .sc-page-sub { font-size:13px; color:#64748b; font-weight:300; margin-bottom:22px; }
                ...
                .sc-stat-icon.blue  { background:#eff6ff; color:#2563eb; }
                .sc-stat-icon.green { background:#f0fdf4; color:#059669; }
                .sc-stat-icon.amber { background:#fffbeb; color:#d97706; }

                .sc-stat-label { font-size:10px; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:#94a3b8; margin-bottom:5px; }
                .sc-stat-val   { font-family:'DM Serif Display',serif; font-size:1.35rem; color:#0f172a; }
                .sc-stat-val.green { color:#15803d; }
                .sc-stat-val.amber { color:#d97706; }
                ...
                .sc-section-label::after { content:''; flex:1; height:1px; background:#e0effe; }
                ...
                .sc-cert-card:hover { box-shadow:0 4px 24px rgba(37,99,235,0.09); }

                /* authority header band */
                .sc-cert-band {
                ...
                .sc-auth-icon {
                    ...
                    font-family:'DM Serif Display',serif; font-size:11px; font-weight:700;
                    flex-shrink:0;
                }
                ...
                .sc-cert-band-auth { font-size:11px; color:#64748b; }
                ...
                .sc-info-cell-label { font-size:9px; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:#94a3b8; margin-bottom:4px; }
                .sc-info-cell-val   { font-size:13px; font-weight:600; color:#0f172a; }
                ...
                .sc-help-note {
                    ...
                    font-size:12px; font-weight:300; color:#475569; line-height:1.65;
                }
                ...
                .sc-step {
                    ...
                    font-size:12px; font-weight:400; color:#475569; line-height:1.55;
                }
                ...
                .sc-btn-secondary {
                    ...
                    background:#fff; border:1px solid #e0effe; border-radius:9px;
                    padding:10px 18px; cursor:pointer; text-decoration:none;
                    transition:background 0.15s, border-color 0.15s;
                    white-space:nowrap;
                }
                .sc-btn-secondary:hover { background:#f0f9ff; border-color:#bfdbfe; color:#2563eb; }

                /* certificate preview image */
                .sc-cert-preview {
                    margin-bottom:16px; border:1px solid #e0effe;
                    border-radius:10px; overflow:hidden; position:relative;
                    background:#f8fbff;
                }
                .sc-cert-preview img { width:100%; display:block; }
                .sc-cert-preview-label {
                    position:absolute; top:8px; left:8px;
                    font-size:9px; font-weight:700; letter-spacing:0.08em; text-transform:uppercase;
                    background:rgba(255,255,255,0.9); color:#475569;
                    padding:3px 8px; border-radius:6px; border:1px solid #e0effe;
                }
                ...
                .sc-empty-icon { width:48px; height:48px; background:#eff6ff; border-radius:13px; display:flex; align-items:center; justify-content:center; margin:0 auto 14px; color:#2563eb; }
                .sc-empty-title { font-size:14px; font-weight:700; color:#0f172a; margin-bottom:5px; }
                .sc-empty-sub   { font-size:12px; font-weight:300; color:#94a3b8; }
            ...
            <div className="sc-root">
                ...
                <div className="sc-page-sub">
                    Track your certificates across all enrolled courses and authorities.
                </div>
                ...
                <div className="sc-section-label">
                    <Award size={13}/> Course Certificates
                </div>
                            ...
                            <div className="sc-cert-band" style={{ background: auth.bg }}>
                                <div className="sc-cert-band-left">
                                    <div
                                        ...
                                        style={{ background: auth.color, color:"#fff" }}
                                    >
                                ...
                                <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                                    <span
                                        className="sc-auth-pill"
                                        style={{ background: auth.bg, color: auth.color, border:`1px solid ${auth.border}` }}
                                    >
                            ...
                            <div className="sc-cert-body">
                                ...
                                {!issued && (
                                    <div className="sc-pending-notice">
                                        ...
                                        <div>
                                            <strong>Certificate not yet issued.</strong> Your certificate will be
                                            available once the course is completed and verified by {auth.name}.
                                            Contact the academy for status updates.
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="sc-info-grid">
                                    <div className="sc-info-cell">
                                        <div className="sc-info-cell-label">Issuing Authority</div>
                                        <div className="sc-info-cell-val">{auth.name}</div>
                                    </div>
                                    <div className="sc-info-cell">
                                        <div className="sc-info-cell-label">Certificate Status</div>
                                        <div className="sc-info-cell-val">{e.certificateStatus}</div>
                                    </div>
                                    {e.course?.duration && (
                                        <div className="sc-info-cell">
                                            <div className="sc-info-cell-label">Course Duration</div>
                                            <div className="sc-info-cell-val">{e.course.duration}</div>
                                        </div>
                                    )}
                                    <div className="sc-info-cell">
                                        <div className="sc-info-cell-label">Portal Login Required</div>
                                        <div className="sc-info-cell-val">
                                            {e.course?.externalLoginRequired ? "Yes" : "No"}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="sc-actions">
                                    {issued && e.course?.verification && (
                                        ...
                                        >
                                            <Search size={13}/> Verify Certificate
                                    ...
                                    {issued && e.course?.externalLoginRequired && e.course?.externalPortalUrl && (
                                        <a
                                            href={e.course.externalPortalUrl}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="sc-btn-secondary"
                                        >
                                            <LogIn size={13}/> {auth.portalLabel}
                                            <ExternalLink size={11}/>
                                        </a>
                                    )}

                                    {/* Fallback if no URLs but issued */}
