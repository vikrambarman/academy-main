...
interface CertTypeData  { _id: string; name: string; code: string; issuingBody: string; }
...
export default function StudentFeeLedger() {
    ...
    return (
        <>
            <style>{sflStyles}</style>
            <div className="sfl-root">

                <div className="sfl-page-title">
                    <Wallet size={22} style={{ color: "var(--sp-accent)" }} /> Fee Ledger
                </div>
                        ...
                        <div key={e._id} className={`sfl-enrollment ${isOpen ? "open" : ""}`}>
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 3, flexWrap: "wrap" }}>
                                        ...
                                        {e.franchise ? (
                                            <span style={{
                                                ...
                                                background: e.franchise.isOwn ? "rgba(245,158,11,0.12)" : "rgba(26,86,219,0.1)",
                                                color: e.franchise.isOwn ? "#F59E0B" : "var(--sp-accent2)",
                                                border: `1px solid ${e.franchise.isOwn ? "rgba(245,158,11,0.25)" : "rgba(26,86,219,0.2)"}`,
                                            }}>
                                                <Shield size={8} /> {e.franchise.code}
                                            </span>
                                        ) : authorityLabel ? (
                                            <span className="sfl-course-auth">{authorityLabel}</span>
                                        ) : null}
                                        {/* Cert type code */}
                                        {e.certType && (
                                            <span style={{ fontSize: 10, color: "var(--sp-muted)" }}>
                                                {e.certType.code}
                                            </span>
                                        )}
                                    </div>
                            ...
                            {isOpen && (
                                <div className="sfl-enroll-body">
                                    ...
                                    {e.franchise && (
                                        <div style={{
                                            background: e.franchise.isOwn ? "rgba(245,158,11,0.06)" : "rgba(26,86,219,0.06)",
                                            border: `1px solid ${e.franchise.isOwn ? "rgba(245,158,11,0.2)" : "rgba(26,86,219,0.15)"}`,
                                            borderRadius: 9, padding: "10px 14px", marginBottom: 16,
                                            display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap",
                                        }}>
                                            <Shield size={13} style={{ color: e.franchise.isOwn ? "#F59E0B" : "var(--sp-accent)", flexShrink: 0 }} />
                                            <div style={{ flex: 1 }}>
                                                <span style={{ fontSize: 12, fontWeight: 700, color: "var(--sp-text)" }}>
                                                    {e.franchise.name}
                                                </span>
                                                {e.certType && (
                                                    <span style={{ fontSize: 11, color: "var(--sp-muted)", marginLeft: 8 }}>
                                                        · {e.certType.name}
                                                    </span>
                                                )}
                                            </div>
                                            {e.externalStudentId && (
                                                <span style={{ fontSize: 11, color: "var(--sp-subtext)" }}>
                                                    {e.franchise.code} ID:{" "}
                                                    <span style={{ fontFamily: "monospace", color: "var(--sp-text)" }}>
                                                        {e.externalStudentId}
                                                    </span>
                                                </span>
                                            )}
                                    ...
                                    <div className="sfl-fee-grid">
                                        ...
                                        <div className="sfl-fee-cell">
                                            ...
                                            <div className={`sfl-fee-cell-val ${due > 0 ? "red" : "green"}`}>
                                    ...
                                    <div className="sfl-pay-title">
                                        <Receipt size={11} /> Payment Records ({sorted.length})
                                    </div>
                                    {sorted.length === 0 ? (
...
const sflStyles = `
    ...
    .sfl-course-name { font-size:14px; font-weight:700; color:var(--sp-text); margin-bottom:2px; }
